...
#ifndef __NOTCHFILTERNODE_H_CED428E__
#define __NOTCHFILTERNODE_H_CED428E__
...
public:
    ...
    double getCentreFreqValueForChannel  (int chan) const;
    double getWidthValueForChannel (int chan) const;
